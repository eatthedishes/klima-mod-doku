...
\begin{figure} \centering \def\svgwidth{\columnwidth} \input{fr320.pdf_tex} \end{figure}
...
\begin{figure} \centering \def\svgwidth{\columnwidth} \input{stabfr.pdf_tex} \end{figure}
% stabgd http://biomath.pythonanywhere.com/stabanalysis/griffeldrazin?dl
\begin{figure} \centering \def\svgwidth{\columnwidth} \input{stabgd.pdf_tex} \end{figure}
...
\begin{figure} \centering \def\svgwidth{\columnwidth} \input{comp.pdf_tex} \end{figure}
